...
const contractAddress = '0xCD4c773a5BA577075A3758499F22E5fBD55fDC6A';  // Replace with your contract's address

const contract = new web3.eth.Contract(contractABI, contractAddress);

// Example function to call a contract method
async function recordPlanting(location, variety) {
    const accounts = await web3.eth.getAccounts();
    const account = accounts[0];

    contract.methods.recordPlanting(location, variety).send({ from: account })
