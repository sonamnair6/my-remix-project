...
async function addToCart(productName, priceInEth) {
    ...
    try {
        await contract.methods.addToCart(productName, priceInEth).send({ from: account });
...
$(document).ready(function(){
    ...
    $('#chatbot-input').keypress(function(event) {
        if(event.which == 13) {
            ...
            // Here you can add the AJAX request to your chatbot backend
            $.ajax({
                url: 'your-chatbot-backend-url',
                method: 'POST',
    ...
    window.handleProductClick = function(productId) {
        // Here you can add the logic to connect to the wallet or add to cart
        if (userIsLoggedIn()) {
            // Direct user to the shop or add to cart
