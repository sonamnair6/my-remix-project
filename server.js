...
// Initialize Web3 with the Ganache RPC URL or MetaMask provider
...
async function interactWithContract() {
  ...
  // Example: Call the addToCart function with parameters
  const productName = 'Product A';
  const priceInEth = web3.utils.toWei('0.1', 'ether'); // Price in Wei
  const quantity = 1;
